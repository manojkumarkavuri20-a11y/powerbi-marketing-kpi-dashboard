-- Campaign performance KPIs: CTR, CPC, CAC and ROAS per campaign, channel, and month
-- Power BI Marketing KPI Dashboard | Author: Manoj Kumar Kavuri | PostgreSQL
-- Written against a merged schema (spend, leads, audience_segment, region); see docs/data_dictionary.md
...
c.campaign_id,
c.campaign_name,
c.channel, -- 'Paid Search', 'Social Media', 'Video', 'Display', 'Affiliate', 'Email'
